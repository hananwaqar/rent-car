  ...
  return (
    <>
      <div className={classNames(className, "text-2xl")}>
        <div className="flex items-center w-full max-w-md px-4 py-2 bg-white border border-gray-300 rounded-full shadow-sm focus-within:ring-2 focus-within:ring-blue-500">
          <HiOutlineSearch />
          <input
            type="text"
            placeholder="Search something here"
            className="flex-1 px-3 text-gray-700 bg-transparent outline-none placeholder-gray-500"
            onChange={handleSearch}
          />
          <div onClick={handleSearchOpen}>
            <FiSliders className="w-5 h-5 text-gray-500 cursor-pointer hover:text-gray-700" />
          </div>
        </div>
      </div>
      <Dialog
